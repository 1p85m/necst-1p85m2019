...
antenna.move_wcs_azel(obs_ra_cmd,obs_dec_cmd,offset_x-dx,offset_y,frame=on_frame)
antenna.tracking_check()
print("track ")
...
antenna.move_wcs_azel(obs_ra_cmd,obs_dec_cmd,offset_x,offset_y,frame=on_frame)
antenna.tracking_check()
print("track ")
obsmode.publish("{0:9}".format('on start'))
time.sleep(integ_on)
...
antenna.move_wcs_azel(obs_ra_cmd,obs_dec_cmd,offset_x,offset_y-dy,frame=on_frame)
antenna.tracking_check()
print("track ")
obsmode.publish("{0:9}".format('on start'))
time.sleep(integ_on)
